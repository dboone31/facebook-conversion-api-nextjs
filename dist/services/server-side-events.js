 ...
 * @constructor
 */
const sendServerSideEvent = (_a) => __awaiter(void 0, [_a], void 0, function* ({ eventName, eventId, emails, phones, firstName, lastName, country, city, zipCode, products, value, currency, fbc, fbp, ipAddress, userAgent, sourceUrl, testEventCode, }) {
    var _b;
    ...
    formData.append('access_token', (_b = process.env.FB_ACCESS_TOKEN) !== null && _b !== void 0 ? _b : '');
