...
const eventHandler = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { eventName, eventId, emails, phones, firstName, lastName, country, city, zipCode, products, value, currency, userAgent, sourceUrl, testEventCode, } = (yield req.json());
    if (!eventName) {
